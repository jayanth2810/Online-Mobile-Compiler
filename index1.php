...
<body>
    <div id="wrapper">
        <h1><a href="index1.php">Online Compiler</a></h1>
        <form id="code" action="copy.php" method="post">
            <div>
                <label for="lang">Select Language:</label>
                <select name="lang" id="lang">
                    <option value="7"  selected="selected"  >Ada (gnat-4.3.2)</option>
    ...
    <!--    <div id="footer">
            Written by: JAYANTH <br> Using <a href="http://ideone.com">Ideone API</a> &copy;
